...
st.markdown("**SIH PS-26145**")
st.markdown("Detection of Malware and Trojans in Software Used in the Power Sector")
...
arch_components = [
    ...
    ("Custom Detectors", "DDoS, DGA, TLS anomaly, Exfiltration, Reconnaissance"),
...
# Detectors
st.markdown("**Detection Capabilities (7 Detectors)**")

detectors = [
    ("DDoS", "Statistical & entropy-based volumetric flood detection", "Custom", "Track B"),
    ("Reconnaissance", "Port and address scan detection", "Zeek Scan", "Track A"),
    ("DGA / DNS", "Machine learning algorithmic domain classifier", "Random Forest", "Track B"),
    ("DNS Tunnelling", "High-frequency DNS query covert channel detection", "RITA", "Track A"),
    ("C2 Beaconing", "Periodic connection beacon detection", "RITA", "Track A"),
    ("Encrypted Malware / TLS", "JA3/JA3S fingerprint + behavioral anomaly", "Custom", "Track B"),
    ("Exfiltration", "Asymmetric upload/download ratio detection", "Custom", "Track B"),
]
...
st.markdown(
    """
    - **Problem Statement:** PS-26145
    - **Domain:** Cyber Security / OT Security
    - **Alert Schema:** v1.0.0
    - **Architecture:** Local-first, offline-capable, no external API dependencies

...
global modbus_read_file_record_request: event(c: connection , headers: ModbusHeaders ) &deprecated="Remove in v7.1. Use the version that takes a byte_count and vector of references";
...
global modbus_read_file_record_response: event(c: connection , headers: ModbusHeaders ) &deprecated="Remove in v7.1. Use the version that takes a byte_count and vector of references";
...
global modbus_write_file_record_request: event(c: connection , headers: ModbusHeaders ) &deprecated="Remove in v7.1. Use the version that takes a byte_count and vector of references";
...
global modbus_write_file_record_response: event(c: connection , headers: ModbusHeaders ) &deprecated="Remove in v7.1. Use the version that takes a byte_count and vector of references";
